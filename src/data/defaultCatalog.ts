...
export function createDefaultCatalog(): SystemCatalog {
  ...
  return {
    ...
    onboardingChecklist: [
      item('Hardware provisionado', { meta: { key: 'hardwareProvisionado' } }),
      item('Conta Entra ID criada', { meta: { key: 'contaEntraIdCriada' } }),
      item('Sistemas liberados', { meta: { key: 'sistemasLiberados' } }),
      item('Crachá solicitado', { meta: { key: 'crachaSolicitado' } }),
      item('Termo enviado', { meta: { key: 'termoEnviado' } }),
    ],
    offboardingChecklist: [
      item('Bloqueio de identidade', { meta: { key: 'bloqueioIdP' } }),
      item('Encerramento de sessões', { meta: { key: 'encerramentoSessoes' } }),
      item('Desvinculação de licenças', { meta: { key: 'desvinculacaoLicencas' } }),
      item('Remoção de grupos de e-mail', { meta: { key: 'remocaoGruposEmail' } }),
      item('Wipe / limpeza MDM', { meta: { key: 'limpezaWipeMDM' } }),
      item('Registro em logs de auditoria', { meta: { key: 'registroLogsAuditoria' } }),
    ],
    users: [
